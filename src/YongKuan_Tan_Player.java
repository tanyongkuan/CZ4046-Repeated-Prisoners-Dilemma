public class YongKuan_Tan_Player {
	/* 
    ...
    class YongKuan_Tan extends Player {
        ...
        int selectAction(int n, int[] myHistory, int[] oppHistory1, int[] oppHistory2) {
            ...
            if (opp1CoopProb >= FRIENDLY_THRESHOLD  && opp2CoopProb >= FRIENDLY_THRESHOLD
                        && oppHistory1[n - 1] == 0  && oppHistory2[n - 1] == 0) {
            	// Good chance that both opponents will cooperate so cooperate so that everyone will be happy
            	return 0;
            } 
                ...
                // there's a high probability that one of them will defect again,
                // so I have to defect to protect myself
                return 1;
            } 
...
//	This is a helper function needed by scoresOfMatch.
	...
	Player makePlayer(int which) {
		...
		case 6: return new YongKuan_Tan();
		}
	...
	public static void main (String[] args) {
		YongKuan_Tan_Player instance = new YongKuan_Tan_Player();
